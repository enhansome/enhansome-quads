# Awesome Quads with stars

A curated list of links to miniquad/macroquad-related code & resources.

## Game engines

* [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,578 | 🐛 334 | 🌐 Rust | 📅 2026-08-05 - simple to use library from author of miniquad.
* [miniquad](https://github.com/not-fl3/miniquad) ⭐ 2,044 | 🐛 153 | 🌐 Rust | 📅 2026-07-25 - main crate, engines below build on top of it. Supports WASM. Therefore everything build on top of it supports WASM too.
* [emerald](https://github.com/Bombfuse/emerald) ⚠️ Archived - game engine with physics, audio, graphics, ECS.
* [good-web-game](https://github.com/not-fl3/good-web-game) ⭐ 349 | 🐛 16 | 🌐 Rust | 📅 2024-05-24 - crate to easily port your [ggez](https://github.com/ggez/ggez) ⭐ 4,681 | 🐛 72 | 🌐 Rust | 📅 2026-06-22 to WASM.
...
* [Zemeroth](https://github.com/ozkriff/zemeroth) ⭐ 1,454 | 🐛 91 | 🌐 Rust | 📅 2024-03-26 - turn-based hexagonal tactical game.
...
* [Rusty Demon Attack](https://github.com/TanTanDev/rusty_demon_attack) ⭐ 71 | 🐛 0 | 🌐 Rust | 📅 2021-11-14 - game inspired by the classic atari game: demon attack.
* [RecWars](https://github.com/martin-t/rec-wars) ⭐ 59 | 🐛 11 | 🌐 Rust | 📅 2025-04-17 - a multiplayer top-down tank shooter playable in browser.
* [unnamed rogue-like by ProfAndreaPollini](https://github.com/ProfAndreaPollini/roguelike-rust-macroquad-noname) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2023-08-04 - a WIP rl done as part of "RogueLikeDev Does the Complete Roguelike Tutorial".
* [cubedesu](https://github.com/stanleydesu/cubedesu) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2023-04-29 - Rubik's Cube simulator.
* [Planetoid](https://github.com/uggla/planetoid) ⭐ 11 | 🐛 12 | 🌐 Rust | 📅 2023-03-06 - a toy project with a goal of creating a multiplayer asteroid game.
* [CyberSub](https://github.com/andreivasiliu/cybersub) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2022-01-06 - a 2D submarine simulation prototype.
* [Tigris and Euphrates](https://github.com/0b01/tigris-and-euphrates) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2026-02-01 - a Rust implementation of T\&E Board game.
* [Caveth](https://github.com/Dequog/caveth) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2022-08-13 - a game where you can shoot enemies with a cannon.
* [Bunner Macroquad](https://github.com/ollej/rust-bunner-macroquad) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2025-02-20 - an implementation in Rust+Macroquad of the game Bunner from Code the Classics vol 1.
* [Dangerous Dave: Rust Ed.](https://github.com/oawad79/dave-rs) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2025-11-21 - a 2D platformer game inspired by the classic "Dangerous Dave" game.
* [Quoridor](https://github.com/baehyunsol/Quoridor-rs) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2024-07-13 - [Quoridor](https://en.wikipedia.org/wiki/Quoridor) implemented in Rust and Macroquad.
* [stunning barnacle](https://github.com/LittleB0xes/stunning_barnacle) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2022-09-18 - a simulator of primitive artificial life using attraction/reuplsion forces between many particles.
* [Isometric Minecraft](https://github.com/bioastroiner/isometric_minecraft) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - an isometric Minecraft-like prototype.
* [Excavation Site Alpha](https://github.com/gamma-delta/excavation-site-alpha) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2021-04-25 - build as far down into the earth as you can for LD48.
...
* [pong-macroquad-hecs](https://github.com/j0of/pong-macroquad-hecs) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2024-01-09 - a "BLAZINGLY FAST" Pong clone implemented using Macroquad and hecs.
...
* [Soldank](https://github.com/smokku/soldank) ⭐ 58 | 🐛 2 | 🌐 Rust | 📅 2025-08-29 - a remake of Soldat game.
...
* [Dig Escape](https://github.com/TanTanDev/DigEscape) ⭐ 88 | 🐛 2 | 🌐 Rust | 📅 2021-07-01 - simple puzzle game about digging.

## Apps or visualizations

### Apps or visualizations: On top of macroquad

* [Portal Explorer](https://github.com/optozorax/portal) ⭐ 549 | 🐛 0 | 🌐 Rust | 📅 2026-07-28 - web visualizator of mind-blowing portals.
* [FDG](https://github.com/grantshandy/fdg) ⭐ 231 | 🐛 5 | 🌐 Rust | 📅 2025-03-06 - a Force Directed Graph framework with a macroqad-based visualizator.
* [cacophony](https://github.com/subalterngames/cacophony) ⭐ 200 | 🐛 7 | 🌐 Rust | 📅 2024-12-10 - a minimalist and ergonomic MIDI sequencer.
...
* [Tarsila](https://github.com/yds12/tarsila) ⭐ 150 | 🐛 20 | 🌐 Rust | 📅 2024-08-27 - pixelart and spritesheet editor.
* [Fuzzy Drone Controller](https://github.com/sparshg/fuzzy-controller) ⭐ 91 | 🐛 0 | 🌐 Rust | 📅 2023-10-23 - a controller that uses Mamdani Fuzzy inference system to control a drone, simulated using a physics engine.
* [Rusty Slider](https://github.com/ollej/rusty-slider) ⭐ 70 | 🐛 2 | 🌐 Rust | 📅 2025-02-20 - markdown slideshow viewer.
* [Escape](https://github.com/bones-ai/rust-escape-ai) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2023-05-14 - AI plays a small escape room game.
* [Sbixel](https://github.com/gale93/sbixel) ⭐ 38 | 🐛 0 | 🌐 Rust | 📅 2025-08-07 - A simple pixel physics simulator.
* [Flappy Bird AI](https://github.com/bones-ai/rust-flappy-bird-ai) ⭐ 37 | 🐛 1 | 🌐 Rust | 📅 2024-03-23 - AI learns to play flappy bird using neuro-evolution.
* [Rusty Aquarium](https://github.com/ollej/rusty-aquarium) ⭐ 33 | 🐛 2 | 🌐 Rust | 📅 2025-02-20 - a monitoring visualization as an aquarium.
* [Sugarcubes](https://github.com/henryksloan/sugarcubes) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2022-03-31 - a tool for designing and testing automata.
* [Sugarcubes](https://github.com/henryksloan/sugarcubes) ⭐ 25 | 🐛 0 | 🌐 Rust | 📅 2022-03-31 - a library and application for automata and formal languages, inspired by JFLAP.
* [eportal](https://github.com/kul-sudo/eportal) ⭐ 24 | 🐛 0 | 🌐 Rust | 📅 2024-12-23 - an evolution simulator.
* [bema](https://github.com/yazgoo/bema) ⭐ 21 | 🐛 0 | 🌐 Rust | 📅 2021-04-30 - slideshow DSL.
* [Shell Texturing Toy](https://github.com/gre-v-el/Shell-Texturing) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2023-11-13 - an interactive shell texturing demo.
* [evolution-rs](https://github.com/kostareg/evolution-rs) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2026-05-26 - simulating the evolution of tiny neural networks.
* [Interactive Particles](https://github.com/cppxor2arr/InteractiveParticles) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2023-01-12 - a playground to interact with particles.
* [Particles editor](https://github.com/not-fl3/particles-editor) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2021-07-17 for your games in macroquad.
* [Fish flocking simulation](https://github.com/eckyputrady/fish-flocking-simulation) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2024-09-08 - a 2D fish flocking simulation.
* [Particle Life](https://github.com/Markek1/particle-life) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2023-12-04 - a particle simulation inspired by Jeffrey Ventrella's Clusters.
* [Collision simulator](https://github.com/Markek1/Collision-Simulator) ⭐ 3 | 🐛 0 | 🌐 Rust | 📅 2022-08-20 - simulating correct particle collisions and algorithms to detect them efficiently.
* [Lorenz Attractor](https://github.com/guydols/Lorenz_Attractor) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2023-03-11 - a Rust implementation and visualization of the [Lorenz Attractor](https://en.wikipedia.org/wiki/Lorenz_system).
* [TawnyAV](https://github.com/LeonStansfield/tawnyAV) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2025-04-18 - Live audio-visual software built on macroquad designed to display dynamic visualizations based on audio captured from a microphone.
* [adambiltcliffe/macroquad-jfa](https://github.com/adambiltcliffe/macroquad-jfa) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2022-08-28 - a PoC demonstration of using the jump flood algorithm to generate outlines around shapes on the GPU using only macroquad.
...
* [With naia](https://github.com/naia-lib/naia/tree/main/demos/macroquad) ⭐ 1,165 | 🐛 33 | 🌐 Rust | 📅 2026-08-11 - a cross-platform (including Wasm!) networking engine built in Rust.
...
* [wasm-bindgen interop](https://github.com/smokku/gwg-bindgen) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-20 - good-web-game + [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,118 | 🐛 560 | 🌐 Rust | 📅 2026-08-12 example
...
* [cargo-webquad](https://github.com/not-fl3/cargo-webquad) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2024-05-20 - a little helper to run debug builds of miniquad/macroquad-based projects on web.

## Libraries

### Libraries: Integrations

* [egui-macroquad](https://github.com/optozorax/egui-macroquad) ⭐ 126 | 🐛 2 | 🌐 Rust | 📅 2025-05-21 - [egui](https://github.com/emilk/egui) ⭐ 30,041 | 🐛 1,124 | 🌐 Rust | 📅 2026-08-12 in macroquad.
* [egui-miniquad](https://github.com/not-fl3/egui-miniquad) ⭐ 105 | 🐛 26 | 🌐 Rust | 📅 2026-08-04 - [egui](https://github.com/emilk/egui) ⭐ 30,041 | 🐛 1,124 | 🌐 Rust | 📅 2026-08-12 in miniquad.
...
* [bevy\_miniquad](https://github.com/smokku/bevy_miniquad) ⭐ 50 | 🐛 0 | 🌐 Rust | 📅 2025-04-01 - [bevy](https://github.com/bevyengine/bevy) ⭐ 47,607 | 🐛 3,387 | 🌐 Rust | 📅 2026-08-13 + miniquad.
* [nonaquad](https://github.com/nokola/nonaquad) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2022-02-18 - vector anti-aliased graphics renderer.
...
* [imgui-miniquad-render](https://github.com/not-fl3/imgui-miniquad-render) ⭐ 5 | 🐛 1 | 🌐 Rust | 📅 2022-10-17 - [imgui-rs](https://github.com/imgui-rs/imgui-rs) ⭐ 3,048 | 🐛 73 | 🌐 Rust | 📅 2026-06-21 in miniquad.
...
* [quad-snd](https://github.com/not-fl3/quad-snd) ⭐ 135 | 🐛 12 | 🌐 Rust | 📅 2026-05-13 - to play sound.
...
* [quad-net](https://github.com/not-fl3/quad-net) ⭐ 17 | 🐛 6 | 🌐 Rust | 📅 2026-07-23 - to use network.
* [gamepads](https://github.com/fornwall/gamepads) ⭐ 17 | 🐛 5 | 🌐 Rust | 📅 2025-02-25 - to access gamepads.
...
* [quad-rand](https://github.com/not-fl3/quad-rand) ⭐ 16 | 🐛 6 | 🌐 Rust | 📅 2026-01-04 - wasm-friendly random number generator for quads.
* [quad-gif](https://github.com/ollej/quad-gif) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-02-10 - library for displaying looping GIF animations.
...
* [sapp-console-log](https://github.com/canadaduane/sapp-console-log) ⭐ 5 | 🐛 0 | 🌐 Rust | 📅 2020-02-07 - [log-rs](https://github.com/rust-lang/log) ⭐ 2,540 | 🐛 19 | 🌐 Rust | 📅 2026-06-24 compatible logging for sapp-wasm.
