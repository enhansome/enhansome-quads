...
* [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,596 | 🐛 335 | 🌐 Rust | 📅 2026-08-18 - simple to use library from author of miniquad.
* [miniquad](https://github.com/not-fl3/miniquad) ⭐ 2,047 | 🐛 154 | 🌐 Rust | 📅 2026-07-25 - main crate, engines below build on top of it. Supports WASM. Therefore everything build on top of it supports WASM too.
...
* [With naia](https://github.com/naia-lib/naia/tree/main/demos/macroquad) ⭐ 1,170 | 🐛 33 | 🌐 Rust | 📅 2026-08-26 - a cross-platform (including Wasm!) networking engine built in Rust.
...
* [wasm-bindgen interop](https://github.com/smokku/gwg-bindgen) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-20 - good-web-game + [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,126 | 🐛 570 | 🌐 Rust | 📅 2026-08-27 example
